...
\newcommand{\thisyrjp}{平成29}
\newcommand{\lastyrjp}{平成28}
\newcommand{\nextyrjp}{平成30}
\newcommand{\thisyrad}{2017}
\newcommand{\lastyrad}{2016}
\newcommand{\nextyrad}{2018}
...
%\part*{第1分冊}
\tableofcontents
%\include{_PF_Sardinops-melanostictus}%     各魚種ファイルを読み込み。以下略。
%\include{_SI_Sardinops-melanostictus}
\include{Sardinops-melanostictus/TW/TW_Sardinops-melanostictus}
%\include{_TW_Engraulis-japonicus}
%\part*{第2分冊}
%\include{_PF_Engraulis-japonicus}
%\include{_SI_Engraulis-japonicus}
%\include{_TW_Engraulis-japonicus}
\include{output/TW_Engraulis-japonicus_nonTAC_1_withB}
%\part*{第2分冊}
%\include{_TW_Engraulis-japonicus}
%\include{sweave_test}
%\onecolumn
